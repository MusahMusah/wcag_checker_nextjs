...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-items-center gap-16 pb-20 font-[family-name:var(--font-geist-sans)] sm:p-20">
      <main className="row-start-1 flex flex-col items-center gap-8 sm:items-start">
        ...
        >
          <div>
            <h1
              id="form-title"
              className="text-left text-2xl font-bold leading-8 text-slate-700"
            >
          ...
          <ButtonLoading
            ...
            aria-label="Submit the uploaded HTML file for WCAG analysis"
          >
            Submit
          </ButtonLoading>
        </form>
